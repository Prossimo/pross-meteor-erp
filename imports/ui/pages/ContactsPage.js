...
export default class ContactsPage extends React.Component {
    ...
    return (
      <div className="contact-page">
        <ContactsList
          ...
          onCreateContact={() =>
            this.setState({ showContactModal: true, creating: true })
          }
        ...
        <ContactOverview
          ...
          onEditContact={() =>
            this.setState({ showContactModal: true, creating: false })
          }
          onConvertToPerson={contact => {
            this.setState({
  ...
  renderContactModal() {
    ...
    const title =
      selectedContact && !creating ? "Edit Contact" : "Create Contact";
    ...
    if (confirm(`Are you sure to remove ${contact.name}?`)) {
      Meteor.call("removeContact", contact._id, (err, res) => {
        ...
        selectedContacts.splice(
          _.findIndex(selectedContacts, { _id: contact._id }),
          1
        );
        this.setState({
          selectedContacts,
