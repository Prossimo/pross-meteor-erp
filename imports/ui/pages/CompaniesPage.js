...
export default class CompaniesPage extends React.Component {
    ...
    return (
      <div className="company-page">
        <CompaniesList
          ...
          onCreateCompany={() =>
            this.setState({ showCompanyModal: true, creating: true })
          }
        ...
        <CompanyOverview
          ...
          onEditCompany={() =>
            this.setState({ showCompanyModal: true, creating: false })
          }
        />
  ...
  renderCompanyModal() {
    ...
    const title =
      selectedCompany && !creating ? "Edit Company" : "Create Company";
