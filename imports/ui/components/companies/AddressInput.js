  ...
  render() {
    ...
    const header = (
      <div style={{ display: "flex" }}>
        ...
        <div>
          <Button bsSize="xsmall" onClick={this.onClickAddAddress}>
                ...
                <tr key={index}>
                  <td>
                    <FormControl
                      ...
                      onChange={e =>
                        this.changeState(address, "address", e.target.value)
                      }
                    />
                  </td>
                  <td>
                    <FormControl
                      ...
                      value={address.type}
                      onChange={e =>
                        this.changeState(address, "type", e.target.value)
                      }
                    />
                  </td>
                  <td>
                  ...
                  <td>
                    <input
                      type="checkbox"
                      checked={address.is_mail}
                      onChange={e =>
                        this.changeState(address, "is_mail", e.target.checked)
                      }
                    />{" "}
                  </td>
                  <td>
                    <Button
                      bsSize="xsmall"
                      onClick={() => this.onClickRemoveAddress(index)}
                    >
