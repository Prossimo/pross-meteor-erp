...
class CommentList extends Component {
  ...
  removeComment(_id, event) {
    ...
    swal({
      ...
      swal("Removed!", "Your comment has been removed.", "success");
    });
  }
                    ...
                    <div>
                      ...
                      <div className="comment-controls">
                        <p className="pull-right">
                          <small>
                            {moment(updatedAt || createdAt).format(
                          ...
                          {user._id === Meteor.userId() ? (
                            <span>
                              <a
                                href="#"
                                onClick={event => this.editComment(_id, event)}
                              >
                                Edit
                              </a>{" "}
                              -
                          ...
                          <a
                            href="#"
                            onClick={event => this.replyComment(_id, event)}
                          >
                            Reply
                          </a>
                        </p>
  ...
  render() {
    const comments = this.props.comments.filter(({ parentId }) => !parentId);
    return this.renderComments(
      _.sortBy(comments, ({ createdAt }) => -createdAt.getTime()),
      0
    );
  }
}
