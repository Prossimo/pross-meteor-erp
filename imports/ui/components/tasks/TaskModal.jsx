...
class TaskModal extends Component {
    ...
    saveTask = () => {
        const {name, assignee, approver, dueDate, description, status, parentId, parentType} = this.state.task
        const task = {
            name,
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-3'>
                            ...
                            <div className='form-group'>
                                ...
                                {
                                    (this.state.isAttach) ? (
                                        <UploadFrom taskFolderId={this.props.taskFolderId} taskId={this.props.task._id}
                                                    close={() => this.changeState(this.state, 'isAttach', false)}
                                                    className='hide'/>
                                    ) : ''
                                }
                            </div>
                            {
                                (hasAssignToMe) ? (
                                    <div className='form-group'>
                                        <button className='btn btn-warning full-width' onClick={this.assignToMe}>Assign
                                            to me
                                        </button>
                                    </div>
                                ) : ''
