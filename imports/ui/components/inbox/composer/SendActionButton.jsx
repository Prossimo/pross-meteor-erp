...
export default class SendActionButton extends React.Component {
    ...
    _orderedActionConfigs() {
        const configKeys = map(this.state.actionConfigs, 'configKey')
        ...
        const preferred = find(this.state.actionConfigs, {configKey: preferredKey})
        const rest = without(this.state.actionConfigs, preferred)
