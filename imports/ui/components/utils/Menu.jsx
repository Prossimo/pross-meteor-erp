...
class MenuItem extends React.Component {
    ...
    render() {
        ...
        if (this.props.divider) {
            const dividerLabel = isString(this.props.divider) ? this.props.divider : ''
            return (
...
class MenuNameEmailItem extends React.Component {
    ...
    render() {
        if (this.props.name && this.props.name.length > 0 && this.props.name != this.props.email)
            return (
                <span>
...
class Menu extends React.Component {
    ...
    componentWillReceiveProps(newProps) {
        ...
        if (selection) {
            ...
            newSelection = find(newProps.items, (item) => this.props.itemKey(item) == selectionKey)
