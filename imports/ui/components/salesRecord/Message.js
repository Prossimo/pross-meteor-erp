...
class Message extends Component {
  constructor(props) {
    super(props);
    this.userName = props.message.author
      ? getUserName(props.message.author, true)
      : props.user;
  }
              ...
              return (
                <Attachment key={id} color={color}>
                  ...
                  <div className="content">
                    <div>
                      <strong>
                        <a {...this.composeLink({ title_link, title })}>
                          {title}
                        </a>
                      </strong>
                    </div>
    ...
    return (
      <li className="activity-msg">
        ...
        <div className="info">
          ...
          <span className="date">
            {moment(message.createAt).format("dddd, MMMM Do YYYY, h:mm ")}
          </span>
        </div>
        {this.formatMessage()}
        {this.renderFile()}
