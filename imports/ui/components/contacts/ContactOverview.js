...
export default class ContactOverview extends React.Component {
  ...
  renderToolbar() {
    ...
    const disabled =
      !contact ||
      (account && !Meteor.user().isAdmin() && account.isTeamAccount);
    return (
      <div className="toolbar-panel">
        ...
        <Button
          bsStyle="danger"
          disabled={disabled}
          onClick={this.onClickRemoveContact}
        >
        ...
        <Button
          bsStyle="success"
          disabled={disabled}
          onClick={this.onClickConvertToPerson}
        >
      ...
      <div style={{ marginTop: 20 }}>
        <div className="thumbnail-view">
          ...
          <div className="info">
            ...
            <div>
              <label>Inbox:</label>
              <span>{contact.account() ? contact.account().name : ""}</span>
            </div>
            <div>
              <label>Phone:</label>
  ...
  onClickConvertToPerson = () => {
    this.props.onConvertToPerson &&
      this.props.onConvertToPerson(this.props.contact);
  };
}
