...
class CreateSalesRecordModal extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            // selectedStage: salesRecord ? _.find(this.stages, {value: this.props.stage}) : this.stages[0],
        ...
        return (
          ...
          >
            <Modal.Header closeButton>
              <Modal.Title id='ModalHeader'>Add Deal</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                          ...
                          <div className="col-md-8">
                            <div>
                                <div className='form-group'>
                                    <label>Stage</label>
                                    <Select
                                        value={selectedStage || this.props.stage}
