                        ...
                        <tbody>
                        {
                            people.map((person, index) => {
                                ...
                                if (person.designation_id) {
                                    designation = find(designations, {_id: person.designation_id})
                                    if (designation) {
                                        ...
                                        if(person.role) roleValue = findIndex(designation.roles, {name:person.role}) > -1 ? {value: person.role, label: person.role} : null
                                        roleAddable = designation.role_addable
                                    }
                                }
                                let companyValue
                                if (person.company_id) {
                                    const company = find(companies, {_id: person.company_id})
