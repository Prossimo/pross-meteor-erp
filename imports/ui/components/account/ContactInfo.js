    ...
    return (
      <div className="contact-info">
        <div className={classNames("field-wrap", { "non-edit": !editable })}>
          ...
          />
          <span
            onClick={this.toggleEditMode.bind(this, "editUsername")}
        ...
        <div className="field-wrap non-edit">
          ...
          <span className={classNames("value")}>{getUserEmail(user)}</span>
        </div>
        <div className={classNames("field-wrap", { "non-edit": !editable })}>
          ...
          />
          <span
            onClick={this.toggleEditMode.bind(this, "editFirstName")}
        ...
        <div className={classNames("field-wrap", { "non-edit": !editable })}>
          ...
          />
          <span
            onClick={this.toggleEditMode.bind(this, "editLastName")}
        ...
        <div className="group-wrap">
          ...
          <div className={classNames("field-wrap", { "non-edit": !editable })}>
            ...
            />
            <span
              onClick={this.toggleEditMode.bind(this, "editTwitter")}
          ...
          <div className={classNames("field-wrap", { "non-edit": !editable })}>
            ...
            />
            <span
              onClick={this.toggleEditMode.bind(this, "editFacebook")}
          ...
          <div className={classNames("field-wrap", { "non-edit": !editable })}>
            ...
            />
            <span
              className={classNames("value", { hide: editLinkedIn })}
        ...
        <div className="role field-wrap non-edit">
          ...
          <span className={classNames("value")}>{getUserRoles(user)}</span>
        </div>
        <div className="group-wrap">
          ...
          <div className={classNames("field-wrap", { "non-edit": !editable })}>
            ...
            />
            <span
              className={classNames("value", { hide: editCompanyName })}
          ...
          <div className={classNames("field-wrap", { "non-edit": !editable })}>
            ...
            />
            <span
              className={classNames("value", { hide: editCompanyPosition })}
